...
namespace Trading.Entity.Mappings.LandAgentBill
{
	public class LandAgentBillMapping : EntityTypeConfiguration<LandAgentBillEntity>, Zerg.Common.Data.IZergMapping
	{
		public LandAgentBillMapping()
		{
			ToTable("LandAgentBill");
			HasKey(c => c.Id);
