...
{
	public class LandAgentBillSearchCondition
	{
		/// <summary>
		/// 页码
		/// </summary>
		...
		public int? LandagentId { get; set; }
		...
		public EnumLandAgentBillSearchOrderBy? OrderBy { get; set; }

	}


	public enum EnumLandAgentBillSearchOrderBy
	{
