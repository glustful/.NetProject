package com.yoopoon.advertisement;
...
public class ProductAdvertisement {
	...
	public ProductAdvertisement(Context context) {
		mContext = context;
	...
	private void initViewPager() {
		...
		adViewPager.setLayoutParams(new LayoutParams(dm.widthPixels, dm.heightPixels * 1 / 3));
