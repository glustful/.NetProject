...
public class FixGridLayout extends ViewGroup {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		for (int i = 0; i < count; i++) {
			...
			/*
			 * 090 This is called to find out how big a view should be. 091 The parent supplies
			 * constraint information in the width and height parameters. 092 The actual mesurement
	...
	protected void dispatchDraw(Canvas canvas) {
		...
		int stroke = Utils.dp2px(getContext(), 1);
		...
		// 绘制边框
		// canvas.drawLine(0, height - 20, width, height - 20, mPaint);
