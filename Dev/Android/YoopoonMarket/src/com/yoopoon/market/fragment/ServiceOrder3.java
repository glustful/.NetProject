...
import com.yoopoon.market.MeServiceOrderCommentActivity_;
...
public class ServiceOrder3 extends Fragment {
	private static final String TAG = "ServiceOrder3";
	View rootView;
	...
	void init() {
		...
		services = meServiceActivity.getServiceList(2);
			...
			if (details != null) {
				...
				holder.tv_btn.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						MeServiceOrderCommentActivity_.intent(getActivity()).details(details).start();
					}
				});
			}
