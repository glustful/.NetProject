...
import com.yoopoon.market.MeOrderCommentActivity_;
...
public class CommentFragment extends Fragment {
	...
	void init() {
		...
		orders = meOrderActivity.getOrderList(3);
	...
	class MyListViewAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			holder.tv_btn.setBackgroundResource(R.drawable.red_border_selector);
			holder.tv_btn.setTextColor(Color.RED);
			holder.tv_btn.setText("评价");
			holder.tv_btn.setPadding(5, 5, 5, 5);
			holder.tv_desc.setText("买家已签收");
			holder.tv_btn.setOnClickListener(new OnClickListener() {

				@Override
				public void onClick(View v) {
					MeOrderCommentActivity_.intent(getActivity()).start();
				}
			});
			return convertView;
		}
