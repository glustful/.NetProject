...
public class CommentFragment extends Fragment {
	...
	void requestData() {
		...
		new RequestAdapter() {
			...
			public void onProgress(ProgressMessage msg) {
				...
				.addParam("status", "3").addParam("page", String.valueOf(page))
	...
	class MyListViewAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			final List<OrderDetailEntity> details = order.Details;
			...
			holder.tv_btn.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					MeOrderCommentActivity_.intent(getActivity()).details(details).startForResult(0);
				}
			});
			return convertView;
		}
