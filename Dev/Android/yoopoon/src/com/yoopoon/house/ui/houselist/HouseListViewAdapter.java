...
public class HouseListViewAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (setBrokerBackground == true) {
			...
			viewHandler.houseTakeGuestTextView.setText("我要带客");
			viewHandler.houseRecommendTextView.setText("我要推荐");
		} else {
			...
			viewHandler.houseTakeGuestTextView.setText("带客");
			viewHandler.houseRecommendTextView.setText("推荐");
		}
