...
public class ResponseData {
	...
	public enum ResultState {
		eSuccess, eFailure, eException, timeout;
	}

	@Override
	public String toString() {
		return "ResponseData [mCode=" + mCode + ", mIs=" + mIs + ", mMsg=" + mMsg + ", mState=" + mState
				+ ", mRootData=" + mRootData + ", mStringData=" + mStringData + ", responseStatus=" + responseStatus
				+ "]";
	}
