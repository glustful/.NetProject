    ...
    ['$rootScope', '$state', '$stateParams', 'AuthService',
        ...
        $stateProvider
            ...
            .state('user.login',{
                ...
                resolve:load(__uri('/modules/Login/controller/LoginController.js')),
                data:{title:'用户登录'}
            })
            .state('user.register',{
                url:'/register?yqm',
                templateUrl:'modules/Register/view/register.html',
                resolve:load(__uri('/modules/Register/controller/RegisterController.js')),
                data:{title:'用户注册'}
            })
            .state('user.PasswordFound',{
                url:'/PasswordFound',
                templateUrl:'modules/PasswordFound/view/PasswordFound.html',
                resolve:load(__uri('/modules/PasswordFound/controller/PasswordController.js')),
                data:{title:'找回密码'}
            })
            .state('app.home',{
                url:'/home',
            ...
            .state('app.broker',{
                ...
                resolve:load(__uri('/modules/broker/controller/broker.js')),
                data:{title:'经纪人专区'}
            })
            .state('app.customerList',{
                url:'/customerList',
                templateUrl:'modules/customerList/view/customerList.html',
                resolve:load(__uri('/modules/customerList/controller/customerList.js')),
                data:{title:'客户列表'}
            })
            .state('app.detail',{
                url:'/detail',
            ...
            .state('app.hero',{
                ...
                resolve:load(__uri("/modules/hero/controller/heroController.js")),
                data:{title:'英雄榜'}
            })
            .state('app.setting',{
                url:'/setting',
                templateUrl:'modules/setting/view/setting.html',
                resolve:load(__uri('/modules/security_setting/controller/SecuritySetting.js')),
            ...
            .state('app.person_setting',{
                ...
                resolve:load(__uri('/modules/person_setting/controller/personsettingController.js')),
                access:['broker','user'],
                data:{title:'个人设置'}
            })
            ...
            .state('app.partner_list',{
                ...
                resolve:load(__uri('/modules/partner_list/controller/partner_list.js')),
                data:{title:'合伙人列表'}
            ...
            .state('app.partner_details',{
                ...
                resolve:load(__uri('/modules/partner_details/controller/partner_details.js')),
                data:{title:'合伙人详情'}
            })
            .state('app.partner_insert',{
                url:'/partner_insert',
                templateUrl:'modules/partner_insert/view/partner_insert.html',
                resolve:load(__uri('/modules/partner_insert/controller/partner_insert.js')),
                data:{title:'添加合伙人'}
            })
            ...
            .state('app.groom',{
                ...
                resolve:load(__uri('/modules/groom/controller/controller.js')),
                data:{title:'我要推荐'}
            })
            ...
            .state('app.houses',{
                ...
                resolve:load(__uri('/modules/houses/controller/houses.js')),
                data:{title:'楼盘详情'}
            ...
            .state('app.BrandDetail',{
                ...
                resolve:load(__uri('/modules/BrandDetail/static/script/brandDetail.js'))
            })
            .state('app.housesBuy',{
                url:'/housesBuy?BrandId',
                templateUrl:'modules/housesBuy/view/housesBuy.html',
                controller:'HousesBuyController',
                resolve:load(__uri('/modules/housesBuy/static/scripts/HousesBuy.js')),
                data:{title:'户型列表'}
            ...
            .state('app.housesPic',{
                ...
                resolve:load(__uri('/modules/housesPic/scripts/HousesPic.js')),
                data:{title:'户型详情'}
            ...
            .state('app.myPurse',{
                ...
                resolve:load(__uri('/modules/myPurse/render/controller.js')),
                data:{title:'提取佣金'}
            ...
            .state('app.personal',{
                ...
                resolve:load(__uri('/modules/personal/controller/personal.js')),
                data:{title:'个人中心'}
            ...
            .state('app.personal_user',{
                ...
                resolve:load(__uri('/modules/personal_user/controller/personal_user.js')),
                data:{title:'个人中心'}
            })
            ...
            .state('app.storeroom',{
                ...
                data:{title:'房源库'},
                resolve:load(__uri('/modules/storeroom/scripts/StoreRoom.js'))
            ...
            .state('app.brand',{
                ...
                resolve:load(__uri('/modules/brandList/scripts/Brand.js'))
            })
            .state('app.task',{
                url:'/task',
                templateUrl:'modules/task/view/task.html',
                resolve:load(__uri('/modules/task/controller/task.js')),
                data:{title:'我的任务'}
            })
            .state('app.nominate',{
                url:'/nominate',
                templateUrl:'modules/nominate/view/nominate.html',
                resolve:load(__uri('/modules/nominate/controller/nominate.js')),
                data:{title:'带客/推荐'}
            })
            .state('app.carry_client',{
                url:'/carry_client?Projectid&name&type',
                templateUrl:'modules/carry_client/view/carry_client.html',
                resolve:load(__uri('/modules/carry_client/controller/controller.js')),
                data:{title:'我要带客'}
            })
            ...
            .state('app.recommendedBroker',{
                ...
                resolve:load(__uri('/modules/recommendBroker/controller/recommendbroker.js')),
            ...
            .state('app.addBroker',{
                ...
                resolve:load(__uri('/modules/addBroker/controller/AddBrokerController.js')),
                data:{title:'添加经纪人'}
            })
            ...
            .state('app.chip',{
                ...
                resolve:load(__uri('/modules/chip/controller/chipcontroller.js'))
            })
            ...
            .state('app.invite',{
                ...
                resolve:load(__uri('/modules/invite/controller/invitecontroller.js')),
                data:{title:'注册邀请'}
            })
            .state('app.cash',{
                url:'/cash',
            ...
            .state('app.selectWithdraw',{
                ...
                resolve:load(__uri('/modules/selectWithdraw/controller/controller.js'))
            })
